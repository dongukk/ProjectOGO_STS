  ...
  <div class="modal-dialog">
    <div class="modal-content" id="login_modalcontent">
        <div class="modal-body" id="login_modalbody">                
         <img src="images/login/closeBtn.png"  id="loginmodal_close" class="btn-close" data-bs-dismiss="modal" aria-label="Close" align="right">
        	<br><br>
		...
		<form action="login" id="loginform">	
			...
			<div class="btn-area" id="sublogin_btnarea">
				...
				<a class="subloingBtn" id="naverlogin" href="#"><img src="images/login/icon_naver.png" id="naverloginimg">네이버 계정으로 로그인</a>
                <a class="subloingBtn" id="kakaologin" href="#" onclick="kakaoLogin()"><img src="images/login/icon_kakao.png" id="kakaologinimg">카카오 계정으로 로그인</a>
			</div>
