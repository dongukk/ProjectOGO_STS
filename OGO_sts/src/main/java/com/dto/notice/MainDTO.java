...
public class MainDTO {
	...
	public MainDTO(String userId, String userPasswd, String userName, String nickname, String gender, String birth,
	...
	public String toString() {
		return "MainDTO [userId=" + userId + ", userPasswd=" + userPasswd + ", userName=" + userName + ", nickname="
				...
				+ ", email1=" + email1 + ", email2=" + email2 + ", profilePhoto=" + profilePhoto + ", hobby=" + hobby
				+ "]";
	}
